...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EdgeFitArgs)(nil), (*config.EdgeFitArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_EdgeFitArgs_To_config_EdgeFitArgs(a.(*EdgeFitArgs), b.(*config.EdgeFitArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.EdgeFitArgs)(nil), (*EdgeFitArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_EdgeFitArgs_To_v1_EdgeFitArgs(a.(*config.EdgeFitArgs), b.(*EdgeFitArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*EdgeFitNodeClass)(nil), (*config.EdgeFitNodeClass)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_EdgeFitNodeClass_To_config_EdgeFitNodeClass(a.(*EdgeFitNodeClass), b.(*config.EdgeFitNodeClass), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.EdgeFitNodeClass)(nil), (*EdgeFitNodeClass)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_EdgeFitNodeClass_To_v1_EdgeFitNodeClass(a.(*config.EdgeFitNodeClass), b.(*EdgeFitNodeClass), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*EdgeFitResource)(nil), (*config.EdgeFitResource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_EdgeFitResource_To_config_EdgeFitResource(a.(*EdgeFitResource), b.(*config.EdgeFitResource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.EdgeFitResource)(nil), (*EdgeFitResource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_EdgeFitResource_To_v1_EdgeFitResource(a.(*config.EdgeFitResource), b.(*EdgeFitResource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*EdgeFitWeights)(nil), (*config.EdgeFitWeights)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_EdgeFitWeights_To_config_EdgeFitWeights(a.(*EdgeFitWeights), b.(*config.EdgeFitWeights), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.EdgeFitWeights)(nil), (*EdgeFitWeights)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_EdgeFitWeights_To_v1_EdgeFitWeights(a.(*config.EdgeFitWeights), b.(*EdgeFitWeights), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_EdgeFitArgs_To_config_EdgeFitArgs(in *EdgeFitArgs, out *config.EdgeFitArgs, s conversion.Scope) error {
	out.NodeClassLabel = in.NodeClassLabel
	if err := Convert_v1_EdgeFitWeights_To_config_EdgeFitWeights(&in.Weights, &out.Weights, s); err != nil {
		return err
	}
	out.Classes = *(*[]config.EdgeFitNodeClass)(unsafe.Pointer(&in.Classes))
	if err := Convert_v1_EdgeFitResource_To_config_EdgeFitResource(&in.MinFragment, &out.MinFragment, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_EdgeFitArgs_To_config_EdgeFitArgs is an autogenerated conversion function.
func Convert_v1_EdgeFitArgs_To_config_EdgeFitArgs(in *EdgeFitArgs, out *config.EdgeFitArgs, s conversion.Scope) error {
	return autoConvert_v1_EdgeFitArgs_To_config_EdgeFitArgs(in, out, s)
}

func autoConvert_config_EdgeFitArgs_To_v1_EdgeFitArgs(in *config.EdgeFitArgs, out *EdgeFitArgs, s conversion.Scope) error {
	out.NodeClassLabel = in.NodeClassLabel
	if err := Convert_config_EdgeFitWeights_To_v1_EdgeFitWeights(&in.Weights, &out.Weights, s); err != nil {
		return err
	}
	out.Classes = *(*[]EdgeFitNodeClass)(unsafe.Pointer(&in.Classes))
	if err := Convert_config_EdgeFitResource_To_v1_EdgeFitResource(&in.MinFragment, &out.MinFragment, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_EdgeFitArgs_To_v1_EdgeFitArgs is an autogenerated conversion function.
func Convert_config_EdgeFitArgs_To_v1_EdgeFitArgs(in *config.EdgeFitArgs, out *EdgeFitArgs, s conversion.Scope) error {
	return autoConvert_config_EdgeFitArgs_To_v1_EdgeFitArgs(in, out, s)
}

func autoConvert_v1_EdgeFitNodeClass_To_config_EdgeFitNodeClass(in *EdgeFitNodeClass, out *config.EdgeFitNodeClass, s conversion.Scope) error {
	out.Name = in.Name
	out.CPU = in.CPU
...
// Convert_v1_EdgeFitNodeClass_To_config_EdgeFitNodeClass is an autogenerated conversion function.
func Convert_v1_EdgeFitNodeClass_To_config_EdgeFitNodeClass(in *EdgeFitNodeClass, out *config.EdgeFitNodeClass, s conversion.Scope) error {
	return autoConvert_v1_EdgeFitNodeClass_To_config_EdgeFitNodeClass(in, out, s)
}

func autoConvert_config_EdgeFitNodeClass_To_v1_EdgeFitNodeClass(in *config.EdgeFitNodeClass, out *EdgeFitNodeClass, s conversion.Scope) error {
	out.Name = in.Name
	out.CPU = in.CPU
	out.Memory = in.Memory
	out.Rank = in.Rank
...
// Convert_config_EdgeFitNodeClass_To_v1_EdgeFitNodeClass is an autogenerated conversion function.
func Convert_config_EdgeFitNodeClass_To_v1_EdgeFitNodeClass(in *config.EdgeFitNodeClass, out *EdgeFitNodeClass, s conversion.Scope) error {
	return autoConvert_config_EdgeFitNodeClass_To_v1_EdgeFitNodeClass(in, out, s)
}

func autoConvert_v1_EdgeFitResource_To_config_EdgeFitResource(in *EdgeFitResource, out *config.EdgeFitResource, s conversion.Scope) error {
	out.CPU = in.CPU
	out.Memory = in.Memory
	return nil
}

// Convert_v1_EdgeFitResource_To_config_EdgeFitResource is an autogenerated conversion function.
func Convert_v1_EdgeFitResource_To_config_EdgeFitResource(in *EdgeFitResource, out *config.EdgeFitResource, s conversion.Scope) error {
	return autoConvert_v1_EdgeFitResource_To_config_EdgeFitResource(in, out, s)
}

func autoConvert_config_EdgeFitResource_To_v1_EdgeFitResource(in *config.EdgeFitResource, out *EdgeFitResource, s conversion.Scope) error {
	out.CPU = in.CPU
	out.Memory = in.Memory
	return nil
}

// Convert_config_EdgeFitResource_To_v1_EdgeFitResource is an autogenerated conversion function.
func Convert_config_EdgeFitResource_To_v1_EdgeFitResource(in *config.EdgeFitResource, out *EdgeFitResource, s conversion.Scope) error {
	return autoConvert_config_EdgeFitResource_To_v1_EdgeFitResource(in, out, s)
}

func autoConvert_v1_EdgeFitWeights_To_config_EdgeFitWeights(in *EdgeFitWeights, out *config.EdgeFitWeights, s conversion.Scope) error {
	out.Class = in.Class
	out.Packing = in.Packing
	out.Balance = in.Balance
	out.Fragmentation = in.Fragmentation
	return nil
}

// Convert_v1_EdgeFitWeights_To_config_EdgeFitWeights is an autogenerated conversion function.
func Convert_v1_EdgeFitWeights_To_config_EdgeFitWeights(in *EdgeFitWeights, out *config.EdgeFitWeights, s conversion.Scope) error {
	return autoConvert_v1_EdgeFitWeights_To_config_EdgeFitWeights(in, out, s)
}

func autoConvert_config_EdgeFitWeights_To_v1_EdgeFitWeights(in *config.EdgeFitWeights, out *EdgeFitWeights, s conversion.Scope) error {
	out.Class = in.Class
	out.Packing = in.Packing
	out.Balance = in.Balance
	out.Fragmentation = in.Fragmentation
...
// Convert_config_EdgeFitWeights_To_v1_EdgeFitWeights is an autogenerated conversion function.
func Convert_config_EdgeFitWeights_To_v1_EdgeFitWeights(in *config.EdgeFitWeights, out *EdgeFitWeights, s conversion.Scope) error {
	return autoConvert_config_EdgeFitWeights_To_v1_EdgeFitWeights(in, out, s)
}
